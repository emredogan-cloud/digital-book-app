                  ...
                  <div class="cover">
                    <div class="cover__crest" aria-hidden="true">
                      <svg viewBox="0 0 120 120" fill="none">
                        <defs>
                          <radialGradient id="cvDawn" cx="50%" cy="58%" r="56%">
                            <stop offset="0%" stop-color="#e9cd8e" stop-opacity="0.95"/>
                            <stop offset="50%" stop-color="#caa260" stop-opacity="0.6"/>
                            <stop offset="100%" stop-color="#6e8694" stop-opacity="0.08"/>
                          </radialGradient>
                          <linearGradient id="cvHorizon" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stop-color="#6e8694" stop-opacity="0"/>
                            <stop offset="50%" stop-color="#9ab0bc"/>
                            <stop offset="100%" stop-color="#6e8694" stop-opacity="0"/>
                          </linearGradient>
                        </defs>
                        <g transform="translate(60 60)">
                          <circle cx="0" cy="8" r="30" fill="url(#cvDawn)"/>
                          <circle cx="0" cy="8" r="18" fill="none" stroke="#d9b977" stroke-width="0.6" opacity="0.6"/>
                          <line x1="-50" y1="24" x2="50" y2="24" stroke="url(#cvHorizon)" stroke-width="1"/>
                          <path d="M -30 -26 q 7 -7 13 0 q 6 -7 13 0"
                                fill="none" stroke="#8aa4b2" stroke-width="1.1" opacity="0.85" stroke-linecap="round"/>
                          <path d="M 12 -16 q 4 -4 7 0 q 3 -4 7 0"
                                fill="none" stroke="#8aa4b2" stroke-width="0.8" opacity="0.6" stroke-linecap="round"/>
                        </g>
                      </svg>
                    </div>
                  ...
                  <div class="cover" style="justify-content:center;">
                    <div class="cover__crest" aria-hidden="true" style="opacity:0.55;">
                      <svg viewBox="0 0 120 120">
                        <g transform="translate(60 60)">
                          <path d="M -22 6 a 22 22 0 0 1 44 0" fill="none" stroke="#8a9aa4" stroke-width="0.6"/>
                          <line x1="-32" y1="6" x2="32" y2="6" stroke="#8a9aa4" stroke-width="0.5" opacity="0.7"/>
                        </g>
                      </svg>
                    </div>
                    <div class="cover__series" style="margin-top:2rem;">Son — Burada Biter</div>
        ...
        _epilogueHtml(book) {
            return `
                <div class="page__inner">
                  <div class="page__content">
                    <div class="epilogue">
                      <h2 class="epilogue__title">Son Söz</h2>
