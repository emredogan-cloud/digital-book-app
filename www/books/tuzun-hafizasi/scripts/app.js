...
(function () {
    ...
    async function boot() {
        ...
        requestAnimationFrame(() => {
            ...
            if (!Storage.getFirstSeen()) {
                ...
                window.LL?.emit('cover_gate_opened', { bookId: 'tuzun-hafizasi' });
            }
        });
    }
    ...
    function handleSpreadChange(spreadIdx) {
        ...
        window.LL?.emit('page_turn', { bookId: 'tuzun-hafizasi', spread: spreadIdx });
    ...
    function wireUI() {
        ...
        dom.btnBookmark.addEventListener("click", () => {
            ...
            if (added) window.LL?.emit('bookmark_add', { bookId: 'tuzun-hafizasi', spread: idx });
        ...
        dom.btnTheme.addEventListener("click", () => {
            ...
            window.LL?.emit('theme_change', { bookId: 'tuzun-hafizasi', theme: next });
        ...
        dom.btnFont.addEventListener("click", async () => {
            ...
            window.LL?.emit('font_scale_change', { bookId: 'tuzun-hafizasi', typeStep: next });
